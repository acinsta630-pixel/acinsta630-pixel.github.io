  ...
  try {
    const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      headers: {
        ...
        "HTTP-Referer": window.location.href, // برای تایید درخواست از سمت مرورگر
        "X-Title": "Amir AI"
      },
      body: JSON.stringify({
        "model": "google/gemini-flash-1.5", // مدل استاندارد و فعال OpenRouter
        "messages": [
    ...
    // چاپ پاسخ کامل در کنسول مرورگر جهت عیب‌یابی
    console.log("پاسخ دریافتی از OpenRouter:", data);
