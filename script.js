...
function think(text){
    ...
    if(teach){
        ...
        let question = teach[1].trim();

        let answer = teach[2].trim();
    ...
    return random([
        ...
        "این رو هنوز یاد نگرفتم 🤔 ولی ذخیره‌اش کردم.",

        "جالبه! این سوال رو نگه داشتم 🧠",
